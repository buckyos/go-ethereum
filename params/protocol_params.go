...
const (
	...
	MaximumExtraDataSize     uint64 = 32    // Maximum size of legacy extra data after Genesis.
	MaximumUSDBExtraDataSize uint64 = 160   // Outer limit for versioned USDB selector payloads.
...
// USDBDevelopmentBTCAnchorMaxAgeBlocks bounds how many additional USDB blocks
// may reuse one BTC anchor on the built-in development network. Public network
// configs must replace this development value after PoW timing calibration.
const USDBDevelopmentBTCAnchorMaxAgeBlocks uint32 = 6_650
