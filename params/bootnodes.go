...
// USDBBootnodes contains the bootstrap set for the standalone USDB network.
// The initial built-in config intentionally leaves this empty until production
// bootnodes are provisioned.
var USDBBootnodes = []string{}

// USDBV5Bootnodes contains the discovery-v5 bootstrap set for the standalone
// USDB network. It remains empty until dedicated USDB discovery nodes exist.
var USDBV5Bootnodes = []string{}
