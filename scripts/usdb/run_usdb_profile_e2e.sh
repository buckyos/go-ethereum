...
export BTC_RPC_PORT="${BTC_RPC_PORT:-27932}"
export BTC_P2P_PORT="${BTC_P2P_PORT:-27933}"
export BH_RPC_PORT="${BH_RPC_PORT:-27910}"
export USDB_INDEXER_RPC_PORT="${USDB_INDEXER_RPC_PORT:-27920}"
export ORD_RPC_PORT="${ORD_RPC_PORT:-27930}"
