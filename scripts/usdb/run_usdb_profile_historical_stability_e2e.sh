...
export BTC_RPC_PORT="${BTC_RPC_PORT:-28132}"
export BTC_P2P_PORT="${BTC_P2P_PORT:-28133}"
export BH_RPC_PORT="${BH_RPC_PORT:-28110}"
export USDB_INDEXER_RPC_PORT="${USDB_INDEXER_RPC_PORT:-28120}"
export ORD_RPC_PORT="${ORD_RPC_PORT:-28130}"
