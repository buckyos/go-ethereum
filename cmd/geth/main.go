...
var (
	...
	nodeFlags = flags.Merge([]cli.Flag{
		...
		utils.EthashUSDBEnabledFlag,
		utils.EthashUSDBRPCURLFlag,
		utils.EthashUSDBTimeoutFlag,
		...
		utils.MinerUSDBEnabledFlag,
		utils.MinerUSDBRPCURLFlag,
		utils.MinerUSDBPassIDFlag,
		utils.MinerUSDBTimeoutFlag,
		utils.NATFlag,
...
func prepare(ctx *cli.Context) {
	...
	switch {
	case ctx.IsSet(utils.USDBFlag.Name):
		log.Info("Starting Geth on USDB network...")
